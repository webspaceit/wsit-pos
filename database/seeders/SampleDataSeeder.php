...
class SampleDataSeeder extends Seeder
{
    ...
    private function seedProducts(): void
    {
        ...
        $products = [
            ['name' => 'Miniket Rice Fine', 'category_id' => $catGroceries->id, 'unit_id' => $uKg->id, 'purchase_price' => 65, 'selling_price' => 75, 'stock_quantity' => 500, 'min_stock' => 50, 'tax_rate' => 5],
            ['name' => 'Basmati Rice Premium', 'category_id' => $catGroceries->id, 'unit_id' => $uKg->id, 'purchase_price' => 120, 'selling_price' => 140, 'stock_quantity' => 200, 'min_stock' => 30, 'tax_rate' => 5],
            ['name' => 'Atta Flour PRAN', 'category_id' => $catGroceries->id, 'unit_id' => $uKg->id, 'purchase_price' => 45, 'selling_price' => 55, 'stock_quantity' => 300, 'min_stock' => 40, 'tax_rate' => 5],
            ['name' => 'Soybean Oil Lucky 5L', 'category_id' => $catOil->id, 'unit_id' => $uLtr->id, 'purchase_price' => 580, 'selling_price' => 650, 'stock_quantity' => 80, 'min_stock' => 15, 'tax_rate' => 7.5],
            ['name' => 'Mustard Oil Teer 1L', 'category_id' => $catOil->id, 'unit_id' => $uLtr->id, 'purchase_price' => 180, 'selling_price' => 210, 'stock_quantity' => 100, 'min_stock' => 20, 'tax_rate' => 7.5],
            ['name' => 'Turmeric Powder Radhuni', 'category_id' => $catOil->id, 'unit_id' => $uPk->id, 'purchase_price' => 35, 'selling_price' => 45, 'stock_quantity' => 200, 'min_stock' => 30, 'tax_rate' => 5],
            ['name' => 'Red Chili Powder Radhuni', 'category_id' => $catOil->id, 'unit_id' => $uPk->id, 'purchase_price' => 55, 'selling_price' => 70, 'stock_quantity' => 180, 'min_stock' => 25, 'tax_rate' => 5],
            ['name' => 'Masoor Dal (Red Lentil)', 'category_id' => $catPulse->id, 'unit_id' => $uKg->id, 'purchase_price' => 130, 'selling_price' => 150, 'stock_quantity' => 150, 'min_stock' => 20, 'tax_rate' => 5],
            ['name' => 'Moong Dal (Yellow Lentil)', 'category_id' => $catPulse->id, 'unit_id' => $uKg->id, 'purchase_price' => 140, 'selling_price' => 160, 'stock_quantity' => 120, 'min_stock' => 20, 'tax_rate' => 5],
            ['name' => 'Coca-Cola 1.5L', 'category_id' => $catSoftDrink->id, 'unit_id' => $uBtl->id, 'purchase_price' => 70, 'selling_price' => 85, 'stock_quantity' => 150, 'min_stock' => 20, 'tax_rate' => 15],
            ['name' => 'Pepsi 1.5L', 'category_id' => $catSoftDrink->id, 'unit_id' => $uBtl->id, 'purchase_price' => 70, 'selling_price' => 85, 'stock_quantity' => 120, 'min_stock' => 20, 'tax_rate' => 15],
            ['name' => 'Sprite 500ml', 'category_id' => $catSoftDrink->id, 'unit_id' => $uBtl->id, 'purchase_price' => 25, 'selling_price' => 35, 'stock_quantity' => 200, 'min_stock' => 30, 'tax_rate' => 15],
            ['name' => 'Fanta Orange 500ml', 'category_id' => $catSoftDrink->id, 'unit_id' => $uBtl->id, 'purchase_price' => 25, 'selling_price' => 35, 'stock_quantity' => 180, 'min_stock' => 25, 'tax_rate' => 15],
            ['name' => '7UP 500ml', 'category_id' => $catSoftDrink->id, 'unit_id' => $uBtl->id, 'purchase_price' => 25, 'selling_price' => 35, 'stock_quantity' => 160, 'min_stock' => 25, 'tax_rate' => 15],
            ['name' => 'Brooke Bond Red Label', 'category_id' => $catTea->id, 'unit_id' => $uPk->id, 'purchase_price' => 95, 'selling_price' => 110, 'stock_quantity' => 100, 'min_stock' => 15, 'tax_rate' => 10],
            ['name' => 'Nescafe Classic 50g', 'category_id' => $catTea->id, 'unit_id' => $uPk->id, 'purchase_price' => 280, 'selling_price' => 320, 'stock_quantity' => 60, 'min_stock' => 10, 'tax_rate' => 10],
            ['name' => 'Lipton Yellow Label', 'category_id' => $catTea->id, 'unit_id' => $uPk->id, 'purchase_price' => 110, 'selling_price' => 130, 'stock_quantity' => 80, 'min_stock' => 12, 'tax_rate' => 10],
            ['name' => 'Lays Classic Salted', 'category_id' => $catChips->id, 'unit_id' => $uPk->id, 'purchase_price' => 45, 'selling_price' => 55, 'stock_quantity' => 200, 'min_stock' => 30, 'tax_rate' => 15],
            ['name' => 'Pringles Original', 'category_id' => $catChips->id, 'unit_id' => $uPk->id, 'purchase_price' => 180, 'selling_price' => 210, 'stock_quantity' => 60, 'min_stock' => 10, 'tax_rate' => 15],
            ['name' => 'Oreo Biscuits', 'category_id' => $catChips->id, 'unit_id' => $uPk->id, 'purchase_price' => 35, 'selling_price' => 45, 'stock_quantity' => 250, 'min_stock' => 30, 'tax_rate' => 15],
            ['name' => 'Ruffles Chips 80g', 'category_id' => $catChips->id, 'unit_id' => $uPk->id, 'purchase_price' => 55, 'selling_price' => 68, 'stock_quantity' => 150, 'min_stock' => 20, 'tax_rate' => 15],
            ['name' => 'Cadbury Dairy Milk 85g', 'category_id' => $catChoco->id, 'unit_id' => $uPk->id, 'purchase_price' => 120, 'selling_price' => 140, 'stock_quantity' => 100, 'min_stock' => 15, 'tax_rate' => 15],
            ['name' => 'Lifebuoy Soap Pack', 'category_id' => $catSoap->id, 'unit_id' => $uPk->id, 'purchase_price' => 140, 'selling_price' => 160, 'stock_quantity' => 80, 'min_stock' => 15, 'tax_rate' => 10],
            ['name' => 'Head Shoulders 340ml', 'category_id' => $catShampoo->id, 'unit_id' => $uBtl->id, 'purchase_price' => 290, 'selling_price' => 330, 'stock_quantity' => 50, 'min_stock' => 10, 'tax_rate' => 10],
            ['name' => 'Colgate MaxFresh', 'category_id' => $catOral->id, 'unit_id' => $uPk->id, 'purchase_price' => 85, 'selling_price' => 100, 'stock_quantity' => 100, 'min_stock' => 20, 'tax_rate' => 10],
            ['name' => 'Sunsilk Shampoo 350ml', 'category_id' => $catShampoo->id, 'unit_id' => $uBtl->id, 'purchase_price' => 250, 'selling_price' => 285, 'stock_quantity' => 60, 'min_stock' => 10, 'tax_rate' => 10],
            ['name' => 'Matador Pen Box', 'category_id' => $catPen->id, 'unit_id' => $uBox->id, 'purchase_price' => 280, 'selling_price' => 350, 'stock_quantity' => 40, 'min_stock' => 10, 'tax_rate' => 10],
            ['name' => 'Fixo Notebook 100pp', 'category_id' => $catNotebook->id, 'unit_id' => $uPcs->id, 'purchase_price' => 45, 'selling_price' => 60, 'stock_quantity' => 300, 'min_stock' => 50, 'tax_rate' => 10],
            ['name' => 'Ticon Pencil Box 12', 'category_id' => $catPen->id, 'unit_id' => $uBox->id, 'purchase_price' => 65, 'selling_price' => 85, 'stock_quantity' => 100, 'min_stock' => 20, 'tax_rate' => 10],
            ['name' => 'Mango Juice PRAN 1L', 'category_id' => $catJuice->id, 'unit_id' => $uBtl->id, 'purchase_price' => 45, 'selling_price' => 55, 'stock_quantity' => 120, 'min_stock' => 20, 'tax_rate' => 15],
            ['name' => 'Non-Stick Frying Pan', 'category_id' => $catCooking->id, 'unit_id' => $uPcs->id, 'purchase_price' => 650, 'selling_price' => 850, 'stock_quantity' => 25, 'min_stock' => 5, 'tax_rate' => 15],
            ['name' => 'Pressure Cooker 5L', 'category_id' => $catCooking->id, 'unit_id' => $uPcs->id, 'purchase_price' => 2500, 'selling_price' => 3200, 'stock_quantity' => 15, 'min_stock' => 5, 'tax_rate' => 15],
            ['name' => 'Nirma Washing Powder', 'category_id' => $catCooking->id, 'unit_id' => $uPk->id, 'purchase_price' => 85, 'selling_price' => 100, 'stock_quantity' => 200, 'min_stock' => 30, 'tax_rate' => 10],
            ['name' => 'Haldiram Namkeen', 'category_id' => $catNamkeen->id, 'unit_id' => $uPk->id, 'purchase_price' => 55, 'selling_price' => 70, 'stock_quantity' => 140, 'min_stock' => 20, 'tax_rate' => 15],
            ['name' => 'Milton Bottle 1L', 'category_id' => $catCooking->id, 'unit_id' => $uPcs->id, 'purchase_price' => 450, 'selling_price' => 600, 'stock_quantity' => 30, 'min_stock' => 5, 'tax_rate' => 15],
        ];
