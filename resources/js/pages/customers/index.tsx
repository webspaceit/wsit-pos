                    ...
                    <div className="rounded-xl bg-white p-6 dark:bg-gray-800 w-full max-w-lg my-4">
                        ...
                        <form onSubmit={submit} className="space-y-3">
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div><label className="block text-sm font-medium mb-1">Credit Limit</label><input type="number" value={data.credit_limit} onChange={(e) => setData('credit_limit', Number(e.target.value))} className="w-full rounded-md border px-3 py-2 text-sm" /></div>
                            </div>
