                    ...
                    <div className="rounded-xl bg-white p-6 dark:bg-gray-800 w-full max-w-md">
                        ...
                        <form onSubmit={submit} className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div><label className="block text-sm font-medium mb-1">Amount *</label><input type="number" step="0.01" value={data.amount} onChange={(e) => setData('amount', e.target.value)} className="w-full rounded-md border px-3 py-2 text-sm" required /></div>
